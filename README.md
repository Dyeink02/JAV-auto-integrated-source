...
JAV自动化爬虫工具是一款运行于 Windows 平台的桌面应用程序，以 Electron 封装，提供图形化界面。软件以 [javbus.com](https://www.javbus.com) 作为主要数据源，支持多镜像域名容灾切换，能够自动化完成影片信息抓取、磁力链接获取、本地视频文件整理、广告过滤、女优排行榜查询等全流程任务。
